...
<script>
	...
	/* function confirmPath(){
		...
		location.href="/main.do?path=" + path; */
		
		/* if(path == "") {
			$(".resultPath").html("");
			alert("경로가 비었습니다.");
		} else {
			//ajaxPost("/getDriverPath.do", path, "successConfirmFile");
			$.ajax({
		        type:"POST",
		        url: "/getDriverPath.do",
		        data:{
		        	path: path
		        },
            				...
            				<ul>
            					<li>
            						...
            						<ul class="path">
            							...
            							<li class="xPath" onclick="showPopup($(this));" draggable="true">css</li>
            						</ul>
            					</li>
            				</ul>
            			</div>
